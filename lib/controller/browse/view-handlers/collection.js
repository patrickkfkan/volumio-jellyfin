...
class CollectionViewHandler extends ExplodableViewHandler {
    ...
    browse() {
        ...
        .then( nav => self.setPageTitle(view, nav, { showParentText: false }) )
        .then( nav => {
            defer.resolve({
                navigation: nav
            });
            ...
            let items = [
                {
                    ...
                    uri: baseUri + '/albums@parentId=' + collectionId + '@sortBy=SortName@sortOrder=Ascending',
                ...
                },
                {
                    ...
                    uri: baseUri + '/songs@parentId=' + collectionId + '@sortBy=Name@sortOrder=Ascending',
